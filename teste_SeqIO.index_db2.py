...
#cria um idex database in disk para acessar os arquivos cds, poupando muita memória, e os arquivos podem ser reutilizados
query_dict = SeqIO.index_db("cds.zma.fasta.idx", "cds.zma.fasta", "fasta")
subject_dict = SeqIO.index_db("cds.gma.fasta.idx", "cds.gma.fasta", "fasta")
